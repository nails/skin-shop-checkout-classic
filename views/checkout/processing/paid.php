...
if (!empty($order)) {
    ...
    ?>
    <div class="nails-skin-shop-checkout-classic processing paid" id="processing-container"
         data-order-ref="<?=$order->ref?>">
        ...
        <div id="thankyou-text" style="display:none">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    $sText = shopSkinSetting('thankyou_text', 'checkout');
                    $aText = json_decode($sText);

                    if (empty($aText)) {
                        echo '<p>If you have any questions please don\'t hesitate to contact us.</p>';
                    } elseif (function_exists('cmsAreaWithData')) {
                        echo cmsAreaWithData($aText);
                    } elseif (!\Nails\Environment::is('PRODUCTION')) {
                        echo '<p class="alert alert-warning">';
                        echo 'Thank you body - CMS Module not available';
